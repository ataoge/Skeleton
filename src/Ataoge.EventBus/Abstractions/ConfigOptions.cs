...
namespace Ataoge.EventBus
{
    ...
    public class ConfigOptions
    {
        ...
        public ConfigOptions()
        {
            ...
            Extensions = new List<IConfigOptionsExtension>();
            Version = DefaultVersion;
            DefaultGroup = "ataoge.queue." + Assembly.GetEntryAssembly().GetName().Name.ToLower();
        }

        internal IList<IConfigOptionsExtension> Extensions { get; }
        ...
        public void RegisterExtension(IConfigOptionsExtension extension)
        {
            if (extension == null)
            {
