    ...
    public static class RepositoryGisExtensions
    {
            ...
            where TEntity : class, IEntity, IHasEwkb
        {
            ...
            else if (geom[0] == '{') //json Extent
            {
             ...
             return query.Where(t => Ataoge.Utilities.GisFunctions.ST_Contains(Ataoge.Utilities.GisFunctions.ST_GeomFromText(geom, dbSrid), t.Shape));
        }
             ...
             where TEntity : class, IEntity, IHasEwkb
        {
            ...
            if (unit == "meter" && srid == 4326)
            {
                ...
                return query.Where(t => Ataoge.Utilities.GisFunctions.ST_DWithin(Ataoge.Utilities.GisFunctions.ST_GeomFromText(geom, srid), t.Shape, dbBuffer));
            }
